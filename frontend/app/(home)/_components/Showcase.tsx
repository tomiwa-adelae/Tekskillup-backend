		...
		<div className="bg-green-400 py-12">
			<div className="container flex flex-col-reverse items-center justify-center gap-5 lg:flex-row">
				<div className="text-center text-white flex items-center justify-center gap-4 flex-col lg:items-start lg:text-left">
					<h1 className="text-3xl leading-relaxed  lg:text-5xl lg:leading-relaxed">
					...
					<div className="flex items-center justify-center gap-5 mt-3">
						<Button
							className="bg-green-200 font-semibold py-8 px-8  hover:bg-inherit"
							asChild
						>
							<Link href="/register">Enroll now</Link>
						</Button>
						<Button
							className="bg-transparent outline outline-2 outline-green-200 font-semibold py-8 px-8"
							asChild
						>
